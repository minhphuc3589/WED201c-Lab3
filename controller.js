// Renders existed data without fetching
const getData = () => {
    const data = [
        ...
        $("tbody").append(
            '<tr>' + 
                ...
                '<td class="d-flex flex-row align-items-center justify-content-center">' +
                    '<button class="action-product-icon m-0 bg-info bg-gradient rounded d-flex align-items-center justify-content-center">' + 
                    ...
                    '<button class="action-product-icon m-1 bg-warning bg-gradient rounded d-flex align-items-center justify-content-center">' +
                    ...
                    '<button class="action-product-icon m-0 bg-danger bg-gradient rounded d-flex align-items-center justify-content-center">' +
